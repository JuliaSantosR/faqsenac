...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA]">
      <section className="bg-[#004581] px-4 pt-12 pb-24 text-white sm:px-6 lg:px-8">
      ...
      <section className="mx-auto max-w-md px-4 pb-16 sm:px-6 lg:px-8">
        <div className="-mt-16 rounded-2xl border border-gray-100 bg-white p-6 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] md:p-8">
          <div className="mb-6 flex items-center gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#004581] text-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="h-11 w-full rounded-xl bg-[#FF8C00] text-sm font-semibold text-white hover:bg-[#e67e00]"
            >
              Entrar
            </Button>
          </form>
